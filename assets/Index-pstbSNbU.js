import{_ as B,o as l,c as d,d as t,a as e,w as o,F as C,g as L,r as s,h as R,e as u,i as x,t as a,j as w,f as N}from"./index-DdwaolGC.js";const Y={class:"api-page-container"},U={class:"page-header"},X={class:"title-section"},W={class:"official-links"},H={class:"control-section"},J={class:"api-categories"},$={class:"api-list"},q={class:"api-title"},Q={class:"api-name"},ee={class:"api-cn"},te={class:"api-content"},oe={key:0,class:"api-section params-section"},ne={class:"section-header"},ie={key:0,class:"children-params"},se={class:"child-param-name"},ae={key:0,class:"default-value"},re={style:{display:"flex","align-items":"center",gap:"8px"}},ce={class:"param-name"},le={key:0,class:"default-value"},me={class:"api-section description-section"},ue={class:"section-header"},de={class:"description-text"},ge={class:"api-section usage-section"},pe={class:"section-header"},ve={class:"code-block"},we={key:1,class:"api-section returns-section"},ye={class:"section-header"},fe={class:"returns-content"},he={class:"returns-desc"},be={__name:"Index",setup(Re){const y=R(["constructor"]),f=R("all"),k=R([]),h=[{name:"constructor",cn:"构造函数",type:"class",category:"members",description:"创建一个新的 View 实例。通过传入配置对象来设置视图的初始状态，包括中心点、缩放级别、旋转角度、投影等。",usage:`import {View} from 'ol';
...
const view = new View({
  ...
  zoom: 5
});`,params:[{name:"options",type:"Object",default:"{}",description:"视图配置选项",children:[{name:"center",type:"Array<number>",default:void 0,description:"初始中心点坐标 [x, y]"},{name:"constrainRotation",type:"boolean|number",default:"true",description:"旋转约束。false 表示无约束，true 或数字表示约束到 90 度的倍数"},{name:"enableRotation",type:"boolean",default:"true",description:"是否启用旋转"},{name:"extent",type:"Array<number>",default:void 0,description:"约束视图的范围 [minX, minY, maxX, maxY]"},{name:"constrainOnlyCenter",type:"boolean",default:"false",description:"如果为 true，范围约束仅应用于视图中心，不应用于分辨率"},{name:"smoothExtentConstraint",type:"boolean",default:"true",description:"如果为 true，范围约束将平滑应用"},{name:"maxResolution",type:"number",default:void 0,description:"最大分辨率（米/像素），用于确定分辨率约束"},{name:"minResolution",type:"number",default:void 0,description:"最小分辨率（米/像素），用于确定分辨率约束"},{name:"maxZoom",type:"number",default:"28",description:"最大缩放级别"},{name:"minZoom",type:"number",default:"0",description:"最小缩放级别"},{name:"multiWorld",type:"boolean",default:"false",description:"如果为 false，视图约束为仅显示一个世界；如果为 true，可以显示多个世界"},{name:"constrainResolution",type:"boolean",default:"false",description:"如果为 true，视图将始终动画到最近的缩放级别；如果为 false，视图可以停在任意分辨率"},{name:"smoothResolutionConstraint",type:"boolean",default:"true",description:"如果为 true，分辨率最小/最大值将平滑应用"},{name:"showFullExtent",type:"boolean",default:"false",description:"允许视图缩放以显示完整配置的范围"},{name:"projection",type:"ProjectionLike",default:"EPSG:3857",description:"投影对象或代码，默认为 Web Mercator (EPSG:3857)"},{name:"resolution",type:"number",default:void 0,description:"初始分辨率（米/像素）。如果未定义，则使用 zoom 计算"},{name:"resolutions",type:"Array<number>",default:void 0,description:"分辨率数组，用于定义可用的缩放级别。如果指定，将覆盖 maxResolution 和 minResolution"},{name:"rotation",type:"number",default:"0",description:"初始旋转角度（弧度），正值表示顺时针旋转"},{name:"zoom",type:"number",default:void 0,description:"初始缩放级别。仅在 resolution 未定义时使用"},{name:"zoomFactor",type:"number",default:"2",description:"用于计算对应分辨率的缩放因子"},{name:"padding",type:"Array<number>",default:"[0, 0, 0, 0]",description:"CSS 像素内边距 [top, right, bottom, left]"}]}],returns:{type:"View",description:"新的 View 实例"}},{name:"padding",cn:"内边距",type:"property",category:"members",description:"视图的内边距设置，用于定义视图中心的偏移。格式为 [top, right, bottom, left]，单位为像素。常用于侧边栏覆盖部分地图时的中心调整。",usage:`// ============================================
// padding 属性使用示例
// ============================================
...
view.setPadding([0, 0, 0, 300]);
// 当侧边栏收起时
view.setPadding([0, 0, 0, 0]);`,returns:{type:"Array<number>",description:"内边距数组 [top, right, bottom, left]，默认为 [0, 0, 0, 0]"}},{name:"adjustCenter",cn:"调整中心点",type:"method",category:"methods",description:"以指定的增量调整视图中心点坐标。正值向东北方向移动，负值向西南方向移动。",usage:`// ============================================
// adjustCenter 方法使用示例
// ============================================
...
// view.setCenter([currentCenter[0] + 1000, currentCenter[1] + 1000]); // 等价于 adjustCenter([1000, 1000])`,params:[{name:"delta",type:"Array<number>",default:void 0,description:"中心点增量 [dx, dy]，单位为米"}]},{name:"adjustResolution",cn:"调整分辨率",type:"method",category:"methods",description:"以指定的增量调整视图分辨率。正值降低分辨率（缩小），负值提高分辨率（放大）。",usage:`// ============================================
...
// - 分辨率越小，地图越详细（放大）
// - 分辨率越大，地图越粗略（缩小）
// - 缩放级别每增加 1，分辨率减半`,params:[{name:"delta",type:"number",default:void 0,description:"分辨率增量（米/像素）"}]},{name:"adjustRotation",cn:"调整旋转角度",type:"method",category:"methods",description:"以指定的增量调整视图旋转角度。正值顺时针旋转，负值逆时针旋转。",usage:`// ============================================
...
// view.setRotation(0);`,params:[{name:"delta",type:"number",default:void 0,description:"旋转角度增量（弧度）"}]},{name:"adjustZoom",cn:"调整缩放级别",type:"method",category:"methods",description:"以指定的增量调整缩放级别。正值放大，负值缩小。",usage:`// ============================================
// adjustZoom 方法使用示例
// ============================================
...
// 级别 10：城市
// 级别 15：街道
// 级别 20+：建筑物细节`,params:[{name:"delta",type:"number",default:void 0,description:"缩放增量（正数放大，负数缩小）"}]},{name:"animate",cn:"视图动画",type:"method",category:"methods",description:"执行视图动画，可以组合多个动画效果（平移、缩放、旋转等）。支持链式调用和回调函数。",usage:`// ============================================
// animate 方法使用示例
// ============================================
...
// - inOut: 慢 - 快 - 慢（用于平滑过渡）
// - linear: 匀速（机械感）`,params:[{name:"var_args",type:"...(Object|Function)",default:void 0,description:"动画选项对象，或 (选项，回调) 序列",children:[{name:"center",type:"Array<number>",default:void 0,description:"动画结束时的中心点坐标 [x, y]"},{name:"zoom",type:"number",default:void 0,description:"动画结束时的缩放级别"},{name:"resolution",type:"number",default:void 0,description:"动画结束时的分辨率（米/像素）"},{name:"rotation",type:"number",default:void 0,description:"动画结束时的旋转角度（弧度）"},{name:"anchor",type:"Array<number>",default:void 0,description:"旋转或分辨率动画时的固定锚点坐标"},{name:"duration",type:"number",default:"1000",description:"动画持续时间（毫秒）"},{name:"easing",type:"Function",default:void 0,description:"缓动函数，如 ol.easing.easeIn, ol.easing.easeOut, ol.easing.inOut"}]}],returns:{type:"Promise<boolean>",description:"动画完成的 Promise"}},{name:"beginInteraction",cn:"开始交互",type:"method",category:"methods",description:"开始用户交互状态。内部使用，通常由 Interaction 类调用。",usage:`// ============================================
...
}`,returns:{type:"void",description:"无返回值"}},{name:"calculateExtent",cn:"计算视图范围",type:"method",category:"methods",description:"计算当前视图的可见范围（边界框）。可选传入画布大小，如果不传则使用当前地图大小。",usage:`// ============================================
...
// 2. 显示当前视图的地理范围
// 3. 限制某些操作在可见范围内
// 4. 计算视图覆盖的面积`,params:[{name:"opt_size",type:"Array<number>",default:"使用地图当前大小",description:"可选的画布大小 [width, height]"}],returns:{type:"Array<number>",description:"边界框 [minX, minY, maxX, maxY]"}},{name:"cancelAnimations",cn:"取消动画",type:"method",category:"methods",description:"取消所有正在进行的视图动画，视图将停留在当前状态。在组件卸载或需要立即停止动画时使用。",usage:`// ============================================
...
// 2. 提升用户体验（快速响应用户操作）
// 3. 节省资源（停止不必要的计算）
// 4. 避免内存泄漏`,returns:{type:"void",description:"无返回值"}},{name:"centerOn",cn:"中心点对齐",type:"method",category:"methods",description:"将地图上的特定点对齐到视口的指定位置。常用于将兴趣点对准视口中心或特定位置。",usage:`// ============================================
// centerOn 方法使用示例
// ============================================
...
//   可以让目标点不在中心，而在任意位置`,params:[{name:"coordinate",type:"Array<number>",default:void 0,description:"地图坐标 [x, y]"},{name:"size",type:"Array<number>",default:void 0,description:"视口大小 [width, height]"},{name:"viewCenter",type:"Array<number>",default:void 0,description:"视口中的目标位置 [x, y]"}]},{name:"changed",cn:"触发变更",type:"method",category:"methods",description:"触发视图变更事件。继承自 Observable，内部使用。",usage:`// ============================================
// changed 方法使用示例
// ============================================
// ⚠️ 注意：这是内部方法，通常不需要直接调用！
...
view.on('change', () => {
  console.log('视图发生变化');
});`,returns:{type:"void",description:"无返回值"}},{name:"dispatchEvent",cn:"分发事件",type:"method",category:"methods",description:"分发事件。继承自 Observable，用于触发自定义事件。",usage:`// ============================================
...
view.dispatchEvent('error');   // 触发错误事件`,params:[{name:"event",type:"string|Object",default:void 0,description:"事件类型或事件对象"}],returns:{type:"*",description:"事件处理结果"}},{name:"endInteraction",cn:"结束交互",type:"method",category:"methods",description:"结束用户交互状态。内部使用，通常由 Interaction 类调用。",usage:`// ============================================
...
if (view.getInteracting()) {
  ...
  console.log('用户未操作地图');
}`,returns:{type:"void",description:"无返回值"}},{name:"fit",cn:"适配视图范围",type:"method",category:"methods",description:"自动调整视图以适配给定的几何图形或边界框，使目标内容完整显示在视图中。这是最常用的方法之一，用于定位到特定区域。",usage:`// ============================================
// fit 方法使用示例
// ============================================
...
// - easing: 缓动函数（控制动画节奏）
// - callback: 动画完成后的回调函数`,params:[{name:"geometryOrExtent",type:"Geometry|Extent",default:void 0,description:"几何对象或边界框 [minX, minY, maxX, maxY]"},{name:"options",type:"Object",default:"{}",description:"可选配置项",children:[{name:"size",type:"Array<number>",default:"地图视口大小",description:"适配的目标大小 [width, height]，默认使用地图视口"},{name:"padding",type:"Array<number>",default:"[0, 0, 0, 0]",description:"内边距 [top, right, bottom, left]，单位为像素，用于在目标区域周围留白"},{name:"nearest",type:"boolean",default:"false",description:"是否缩放到最近的整数级别，当 constrainResolution 为 true 时有效"},{name:"minResolution",type:"number",default:"0",description:"允许的最小分辨率（米/像素），限制最大缩放"},{name:"maxZoom",type:"number",default:"视图最大缩放",description:"允许的最大缩放级别，防止缩放过近"},{name:"minZoom",type:"number",default:"视图最小缩放",description:"允许的最小缩放级别，防止缩放过远"},{name:"duration",type:"number",default:"0",description:"动画持续时间（毫秒），设为 0 立即完成"},{name:"easing",type:"Function",default:"ol.easing.easeOut",description:"缓动函数，控制动画节奏，如 ol.easing.in, ol.easing.out, ol.easing.inOut"},{name:"callback",type:"Function",default:void 0,description:"动画完成后的回调函数，参数为布尔值表示是否完成"}]}],returns:{type:"number|undefined",description:"缩放级别，如果无法计算则返回 undefined"}},{name:"get",cn:"获取属性",type:"method",category:"methods",description:"获取视图的自定义属性。继承自 BaseObject，支持键值对存储。",usage:`// ============================================
// get 方法使用示例
// ============================================
// 方法说明：get(key)
// 作用：获取视图的自定义属性
...
// view.getResolution() 比 view.get('resolution') 更常用`,params:[{name:"key",type:"string",default:void 0,description:"属性键名"}],returns:{type:"*",description:"属性值"}},{name:"getAnimating",cn:"检查是否正在动画",type:"method",category:"methods",description:"检查视图当前是否正在进行动画。",usage:`// ============================================
// getAnimating 方法使用示例
// ============================================
// 方法说明：getAnimating()
...
}`,returns:{type:"boolean",description:"是否正在动画"}},{name:"getCenter",cn:"获取中心点坐标",type:"method",category:"methods",description:"获取当前视图的中心点坐标。返回的是投影坐标（对于默认投影 EPSG:3857，单位为米）。",usage:`// ============================================
// getCenter 方法使用示例
// ============================================
// 方法说明：getCenter()
...
// - 使用 toLonLat() 进行转换
// - 使用 fromLonLat() 进行反向转换`,returns:{type:"Array<number>|undefined",description:"中心点坐标数组 [x, y]，如果未设置则返回 undefined"}},{name:"getInteracting",cn:"检查是否正在交互",type:"method",category:"methods",description:"检查用户当前是否正在与视图交互（如拖拽、缩放等）。",usage:`// ============================================
...
// - getAnimating: 是否正在执行动画（可能是程序触发的）`,returns:{type:"boolean",description:"是否正在交互"}},{name:"getKeys",cn:"获取属性键",type:"method",category:"methods",description:"获取所有自定义属性的键名数组。继承自 BaseObject。",usage:`// ============================================
// getKeys 方法使用示例
// ============================================
// 方法说明：getKeys()
// 返回：所有自定义属性的键名数组
...
}`,returns:{type:"Array<string>",description:"属性键名数组"}},{name:"getMaxResolution",cn:"获取最大分辨率",type:"method",category:"methods",description:"获取视图允许的最大分辨率（最缩小状态）。基于 minZoom 计算。",usage:`// ============================================
...
// - 分辨率越大 → 地图越缩小 → 看到范围越大
// - 分辨率越小 → 地图越放大 → 看到范围越小
// - maxResolution 是允许的最大值（最缩小状态）`,returns:{type:"number",description:"最大分辨率（米/像素）"}},{name:"getMaxZoom",cn:"获取最大缩放级别",type:"method",category:"methods",description:"获取视图允许的最大缩放级别。超过此级别后无法继续放大。",usage:`// ============================================
// getMaxZoom 方法使用示例
// ============================================
// 方法说明：getMaxZoom()
// 返回：最大缩放级别（数字）
...
// 13-15: 街道
// 16-18: 建筑物
// 19+: 室内/细节`,returns:{type:"number",description:"最大缩放级别"}},{name:"getMinResolution",cn:"获取最小分辨率",type:"method",category:"methods",description:"获取视图允许的最小分辨率（最放大状态）。基于 maxZoom 计算。",usage:`// ============================================
...
// - 分辨率越小 → 地图越放大 → 细节越清晰
// - 分辨率越大 → 地图越缩小 → 范围越广
// - minResolution 是允许的最小值（最放大状态）`,returns:{type:"number",description:"最小分辨率（米/像素）"}},{name:"getMinZoom",cn:"获取最小缩放级别",type:"method",category:"methods",description:"获取视图允许的最小缩放级别。低于此级别后无法继续缩小。",usage:`// ============================================
// getMinZoom 方法使用示例
// ============================================
// 方法说明：getMinZoom()
// 返回：最小缩放级别（数字）
...
// 3-5: 国家/省份
// 6-9: 城市
// 10+: 详细街道`,returns:{type:"number",description:"最小缩放级别"}},{name:"getProjection",cn:"获取投影对象",type:"method",category:"methods",description:"获取视图使用的投影对象。默认为 EPSG:3857（Web Mercator 投影）。",usage:`// ============================================
...
// EPSG:326xx - UTM 投影（区域投影）`,returns:{type:"Projection",description:"投影对象"}},{name:"getProperties",cn:"获取所有属性",type:"method",category:"methods",description:"获取所有自定义属性的对象。继承自 BaseObject。",usage:`// ============================================
...
// - getProperties(): 返回属性对象 {key1: 'v1', key2: 'v2'}`,returns:{type:"Object",description:"属性对象"}},{name:"getResolution",cn:"获取分辨率",type:"method",category:"methods",description:"获取当前视图的分辨率，即每个像素代表的地图单位数（对于 EPSG:3857 投影，单位为米）。分辨率越小，地图显示越详细。",usage:`// ============================================
...
// 10-100 米/像素：城市地图
// 100-1000 米/像素：区域地图
// > 1000 米/像素：全国/全球地图`,returns:{type:"number|undefined",description:"当前分辨率（米/像素）"}},{name:"getResolutionForExtent",cn:"根据范围获取分辨率",type:"method",category:"methods",description:"计算适配给定范围所需的分辨率。",usage:`// ============================================
...
// - fit: 自动计算并执行动画（更常用）
// 建议：如果需要动画效果，直接使用 fit() 方法`,params:[{name:"extent",type:"Array<number>",default:void 0,description:"范围 [minX, minY, maxX, maxY]"},{name:"size",type:"Array<number>",default:"视口大小",description:"可选的视口大小 [width, height]"}],returns:{type:"number",description:"适配范围的分辨率"}},{name:"getResolutionForZoom",cn:"根据缩放获取分辨率",type:"method",category:"methods",description:"获取指定缩放级别对应的分辨率。",usage:`// ============================================
...
// 【缩放级别与分辨率关系】
// 分辨率 = 初始分辨率 / (2 ^ zoom)
// 每增加 1 级，分辨率减半（精度翻倍）`,params:[{name:"zoom",type:"number",default:void 0,description:"缩放级别"}],returns:{type:"number",description:"分辨率"}},{name:"getResolutions",cn:"获取分辨率数组",type:"method",category:"methods",description:"获取视图的分辨率数组。当 constrainResolution 为 true 时，只能使用这些分辨率。",usage:`// ============================================
...
// - 用于创建自定义的缩放级别控制
// - 用于动画中精确控制缩放过程`,returns:{type:"Array<number>|undefined",description:"分辨率数组"}},{name:"getRevision",cn:"获取修订版本",type:"method",category:"methods",description:"获取视图对象的修订版本号。每次视图状态改变时，版本号会递增。继承自 Observable。",usage:`// ============================================
// getRevision 方法使用示例
// ============================================
// 方法说明：getRevision()
// 返回：修订版本号（整数）
...
// - 检测视图状态变化
// - 性能优化（避免不必要的重绘）
// - 调试和日志记录`,returns:{type:"number",description:"修订版本号"}},{name:"getRotation",cn:"获取旋转角度",type:"method",category:"methods",description:"获取视图的旋转角度，以弧度为单位。0 表示正北方向向上，正值表示顺时针旋转。",usage:`// ============================================
// getRotation 方法使用示例
// ============================================
// 方法说明：getRotation()
// 返回：旋转角度（弧度），0 表示北方朝上
...
// -π/2 弧度 ≈ -1.57 = -90 度（逆时针 90 度，西方朝上）`,returns:{type:"number",description:"旋转角度（弧度，顺时针为正，默认为 0）"}},{name:"getZoom",cn:"获取缩放级别",type:"method",category:"methods",description:"获取当前视图的缩放级别。缩放级别是一个浮点数值，值越大表示地图显示越详细。",usage:`// ============================================
// getZoom 方法使用示例
// ============================================
// 方法说明：getZoom()
...
// 13-15: 街道
// 16-18: 建筑物
// 19+: 室内/细节`,returns:{type:"number|undefined",description:"当前缩放级别，如果未设置则返回 undefined"}},{name:"getZoomForResolution",cn:"根据分辨率获取缩放",type:"method",category:"methods",description:"获取指定分辨率对应的缩放级别。",usage:`// ============================================
...
// 两者互为逆运算`,params:[{name:"resolution",type:"number",default:void 0,description:"分辨率"}],returns:{type:"number",description:"缩放级别"}},{name:"on",cn:"监听事件",type:"method",category:"methods",description:"监听视图事件。View 继承自 Observable，支持事件监听机制。",usage:`// ============================================
// on 方法使用示例
// ============================================
...
// propertychange: 属性变化`,params:[{name:"type",type:"string",default:void 0,description:"事件类型"},{name:"listener",type:"Function",default:void 0,description:"回调函数"}],returns:{type:"EventsKey|Array<EventsKey>",description:"事件键，用于取消监听"}},{name:"once",cn:"监听一次事件",type:"method",category:"methods",description:"监听事件一次，触发后自动移除。继承自 Observable。",usage:`// ============================================
// once 方法使用示例
// ============================================
...
// once: 只监听一次，触发后自动取消`,params:[{name:"type",type:"string",default:void 0,description:"事件类型"},{name:"listener",type:"Function",default:void 0,description:"回调函数"}],returns:{type:"EventsKey|Array<EventsKey>",description:"事件键"}},{name:"set",cn:"设置属性",type:"method",category:"methods",description:"设置视图的自定义属性。继承自 BaseObject。",usage:`// ============================================
// set 方法使用示例
// ============================================
// 方法说明：set(key, value)
// 作用：设置自定义属性
...
// - 可以使用 get 获取
// - 可以使用 unset 删除`,params:[{name:"key",type:"string",default:void 0,description:"属性键名"},{name:"value",type:"*",default:void 0,description:"属性值"}]},{name:"setCenter",cn:"设置中心点坐标",type:"method",category:"methods",description:"设置视图的中心点坐标。坐标应为地图投影单位的坐标。对于默认投影（EPSG:3857），单位为米。",usage:`// ============================================
// setCenter 方法使用示例
// ============================================
...
// animate: 平滑移动，有动画（适合用户交互）`,params:[{name:"center",type:"Array<number>|undefined",default:void 0,description:"中心点坐标 [x, y] 或 undefined"}]},{name:"setConstrainResolution",cn:"设置约束分辨率",type:"method",category:"methods",description:"设置是否限制为整数缩放级别。当为 true 时，缩放会被约束到预定义的分辨率级别。",usage:`// ============================================
...
// true:  缩放级别只能是 10, 11, 12...（阶梯式）`,params:[{name:"constrainResolution",type:"boolean",default:void 0,description:"是否约束分辨率"}]},{name:"setMaxZoom",cn:"设置最大缩放级别",type:"method",category:"methods",description:"设置视图允许的最大缩放级别。",usage:`// ============================================
// setMaxZoom 方法使用示例
// ============================================
...
// 17: 建筑物级别（可以看到房屋轮廓）
// 19: 细节级别（可以看到车辆、行人）
// 20+: 超细节级别`,params:[{name:"maxZoom",type:"number",default:void 0,description:"最大缩放级别"}]},{name:"setMinZoom",cn:"设置最小缩放级别",type:"method",category:"methods",description:"设置视图允许的最小缩放级别。",usage:`// ============================================
// setMinZoom 方法使用示例
// ============================================
...
// 3: 国家级别
// 5: 省份级别
// 8: 城市级别`,params:[{name:"minZoom",type:"number",default:void 0,description:"最小缩放级别"}]},{name:"setProperties",cn:"设置多个属性",type:"method",category:"methods",description:"批量设置多个自定义属性。继承自 BaseObject。",usage:`// ============================================
...
// 多次 set: 每次设置一个，触发多次 propertychange`,params:[{name:"properties",type:"Object",default:void 0,description:"属性对象"}]},{name:"setResolution",cn:"设置分辨率",type:"method",category:"methods",description:"设置视图的分辨率。分辨率决定了地图显示的详细程度，分辨率越小表示地图越详细。",usage:`// ============================================
...
// 10 米/像素：街道范围
// 1 米/像素：建筑物范围
// 0.1 米/像素：室内范围`,params:[{name:"resolution",type:"number|undefined",default:void 0,description:"分辨率值（米/像素）"}]},{name:"setRotation",cn:"设置旋转角度",type:"method",category:"methods",description:"设置视图的旋转角度。正值表示顺时针旋转，负值表示逆时针旋转。常用于实现地图旋转功能。",usage:`// ============================================
// setRotation 方法使用示例
// ============================================
...
// π/2 ≈ 1.57 = 90 度（东方朝上）
// π ≈ 3.14 = 180 度（南方朝上）
// -π/2 ≈ -1.57 = -90 度（西方朝上）`,params:[{name:"rotation",type:"number",default:void 0,description:"旋转角度（弧度）"}]},{name:"setZoom",cn:"设置缩放级别",type:"method",category:"methods",description:"设置视图的缩放级别。缩放级别决定了地图显示的详细程度。",usage:`// ============================================
// setZoom 方法使用示例
// ============================================
// 方法说明：setZoom(zoom)
// 作用：直接设置缩放级别（无动画）
...
// 10-12: 城区
// 13-15: 街道
// 16-18: 建筑物`,params:[{name:"zoom",type:"number|undefined",default:void 0,description:"缩放级别（通常为 0-28 之间）"}]},{name:"un",cn:"取消监听",type:"method",category:"methods",description:"取消事件监听。继承自 Observable。",usage:`// ============================================
// un 方法使用示例
// ============================================
...
// 1. 防止内存泄漏
// 2. 避免重复触发
// 3. 组件清理时需要`,params:[{name:"key",type:"EventsKey|Array<EventsKey>",default:void 0,description:"事件键"}]},{name:"unset",cn:"删除属性",type:"method",category:"methods",description:"删除视图的自定义属性。继承自 BaseObject。",usage:`// ============================================
// unset 方法使用示例
// ============================================
// 方法说明：unset(key)
// 作用：删除自定义属性
...
// unset('key'): 完全删除属性
// set('key', undefined): 设置值为 undefined，属性仍存在`,params:[{name:"key",type:"string",default:void 0,description:"属性键名"}]},{name:"change",cn:"变更事件",type:"event",category:"events",description:"当视图任何属性改变时触发。这是通用的变更事件。",usage:`// ============================================
// change 事件使用示例
// ============================================
// 事件说明：当视图任何属性改变时触发
...
// 建议：优先使用特定事件，减少不必要的触发`,returns:{type:"BaseEvent",description:"事件对象"}},{name:"change:center",cn:"中心点变更事件",type:"event",category:"events",description:"当视图中心点改变时触发。",usage:`// ============================================
...
// 4. 调用 view.fit()
// 5. 调用 view.centerOn()`,returns:{type:"BaseEvent",description:"事件对象"}},{name:"change:resolution",cn:"分辨率变更事件",type:"event",category:"events",description:"当视图分辨率（缩放级别）改变时触发。",usage:`// ============================================
...
// 10-12: 城市
// 13-15: 街道/社区
// 16-18: 建筑物/详情`,returns:{type:"BaseEvent",description:"事件对象"}},{name:"change:rotation",cn:"旋转变更事件",type:"event",category:"events",description:"当视图旋转角度改变时触发。",usage:`// ============================================
...
// Math.PI/2  = 90°  = 东方朝上
// Math.PI    = 180° = 南方朝上
// -Math.PI/2 = -90° = 西方朝上`,returns:{type:"BaseEvent",description:"事件对象"}},{name:"error",cn:"错误事件",type:"event",category:"events",description:"当视图发生错误时触发。",usage:`// ============================================
// error 事件使用示例
// ============================================
// 事件说明：当视图发生错误时触发
...
// 2. 投影错误：坐标转换失败、投影未定义
// 3. 瓦片错误：网络问题、瓦片源不可用
// 4. 数据错误：GeoJSON 格式错误、数据解析失败`,returns:{type:"BaseEvent",description:"事件对象"}},{name:"propertychange",cn:"属性变更事件",type:"event",category:"events",description:"当视图的自定义属性改变时触发。继承自 BaseObject。",usage:`// ============================================
...
// 3. view.setRotation() - 触发 change:rotation`,returns:{type:"ObjectEvent",description:"包含 key 和 value 的事件对象"}}];(()=>{const r={all:{name:"all",cn:"全部",count:h.length},members:{name:"members",cn:"Members",count:0},methods:{name:"methods",cn:"Methods",count:0},events:{name:"events",cn:"Events",count:0}};h.forEach(n=>{r[n.category]&&r[n.category].count++}),k.value=Object.values(r)})();const b=N(()=>f.value==="all"?h:h.filter(r=>r.category===f.value)),M=r=>({method:"primary",property:"success",event:"warning",class:"danger"})[r]||"info",_=r=>{f.value=r,b.value.length>0&&(y.value=[b.value[0].name])},E=()=>{y.value=b.value.map(r=>r.name)},P=()=>{y.value=[]};return(r,n)=>{const j=s("Link"),g=s("el-icon"),I=s("el-link"),S=s("FolderOpened"),Z=s("el-button"),O=s("Folder"),p=s("el-tag"),F=s("Operation"),m=s("el-table-column"),z=s("el-table"),A=s("Reading"),T=s("Console"),V=s("Select"),D=s("el-collapse-item"),G=s("el-collapse");return l(),d("div",Y,[t("div",U,[t("div",X,[n[2]||(n[2]=t("h2",null,"View - 视图控制 API",-1)),n[3]||(n[3]=t("p",{class:"description"}," OpenLayers View 用于控制地图的显示状态，包括中心点、缩放级别、旋转角度等。 View 是地图的核心组件之一，负责管理地图的可视区域。 ",-1)),t("div",W,[e(I,{type:"primary",href:"https://openlayers.org/en/latest/apidoc/module-ol_View-View.html",target:"_blank"},{default:o(()=>[e(g,null,{default:o(()=>[e(j)]),_:1}),n[1]||(n[1]=u(" 官方文档 ",-1))]),_:1})])]),t("div",H,[e(Z,{onClick:E,size:"default"},{default:o(()=>[e(g,null,{default:o(()=>[e(S)]),_:1}),n[4]||(n[4]=u(" 全部展开 ",-1))]),_:1}),e(Z,{onClick:P,size:"default"},{default:o(()=>[e(g,null,{default:o(()=>[e(O)]),_:1}),n[5]||(n[5]=u(" 全部收起 ",-1))]),_:1})])]),t("div",J,[(l(!0),d(C,null,L(k.value,i=>(l(),x(p,{key:i.name,type:f.value===i.name?"primary":"info",effect:"plain",class:"category-tag",onClick:K=>_(i.name)},{default:o(()=>[u(a(i.cn)+" ("+a(i.count)+") ",1)]),_:2},1032,["type","onClick"]))),128))]),t("div",$,[e(G,{modelValue:y.value,"onUpdate:modelValue":n[0]||(n[0]=i=>y.value=i)},{default:o(()=>[(l(!0),d(C,null,L(b.value,(i,K)=>(l(),x(D,{key:i.name,name:i.name},{title:o(()=>[t("div",q,[e(p,{type:M(i.type),size:"small"},{default:o(()=>[u(a(i.type),1)]),_:2},1032,["type"]),t("span",Q,a(i.name),1),t("span",ee,a(i.cn),1)])]),default:o(()=>[t("div",te,[i.params&&i.params.length?(l(),d("div",oe,[t("div",ne,[e(g,{class:"section-icon params-icon"},{default:o(()=>[e(F)]),_:1}),n[6]||(n[6]=t("h4",null,"参数说明",-1))]),e(z,{data:i.params,style:{width:"100%"},size:"small",border:"",class:"api-table","row-key":"name"},{default:o(()=>[e(m,{type:"expand",width:"50"},{default:o(c=>[c.row.children&&c.row.children.length?(l(),d("div",ie,[e(z,{data:c.row.children,size:"small",border:"",class:"children-table"},{default:o(()=>[e(m,{prop:"name",label:"子参数",width:"150"},{default:o(v=>[t("code",se,a(v.row.name),1)]),_:1}),e(m,{prop:"type",label:"类型",width:"140"},{default:o(v=>[e(p,{size:"small",type:"info"},{default:o(()=>[u(a(v.row.type),1)]),_:2},1024)]),_:1}),e(m,{prop:"default",label:"默认值",width:"120"},{default:o(v=>[v.row.default?(l(),d("span",ae,a(v.row.default),1)):w("",!0)]),_:1}),e(m,{prop:"description",label:"说明"})]),_:1},8,["data"])])):w("",!0)]),_:1}),e(m,{prop:"name",label:"参数名",width:"180"},{default:o(c=>[t("div",re,[t("code",ce,a(c.row.name),1),c.row.children&&c.row.children.length?(l(),x(p,{key:0,size:"small",type:"warning"},{default:o(()=>[...n[7]||(n[7]=[u("可展开",-1)])]),_:1})):w("",!0)])]),_:1}),e(m,{prop:"type",label:"类型",width:"150"},{default:o(c=>[e(p,{size:"small",type:"info"},{default:o(()=>[u(a(c.row.type),1)]),_:2},1024)]),_:1}),e(m,{prop:"default",label:"默认值",width:"120"},{default:o(c=>[c.row.default?(l(),d("span",le,a(c.row.default),1)):w("",!0)]),_:1}),e(m,{prop:"description",label:"说明"})]),_:1},8,["data"])])):w("",!0),t("div",me,[t("div",ue,[e(g,{class:"section-icon description-icon"},{default:o(()=>[e(A)]),_:1}),n[8]||(n[8]=t("h4",null,"功能说明",-1))]),t("p",de,a(i.description),1)]),t("div",ge,[t("div",pe,[e(g,{class:"section-icon usage-icon"},{default:o(()=>[e(T)]),_:1}),n[9]||(n[9]=t("h4",null,"使用示例",-1))]),t("pre",ve,[t("code",null,a(i.usage),1)])]),i.returns?(l(),d("div",we,[t("div",ye,[e(g,{class:"section-icon returns-icon"},{default:o(()=>[e(V)]),_:1}),n[10]||(n[10]=t("h4",null,"返回值",-1))]),t("div",fe,[e(p,{size:"small",type:"success",class:"return-type-tag"},{default:o(()=>[u(a(i.returns.type),1)]),_:2},1024),t("span",he,a(i.returns.description),1)])])):w("",!0)])]),_:2},1032,["name"]))),128))]),_:1},8,["modelValue"])])])}}},Ze=B(be,[["__scopeId","data-v-191b7f60"]]);export{Ze as default};
