      ...
      <div class="doc-content">
        <div class="page-header">
          <div class="title-section">
            <h2>VectorTileSource - 矢量切片数据源</h2>
            <p class="description">
              VectorTileSource 用于加载矢量切片数据（如 MVT/PBF 格式）。矢量切片结合了矢量数据的灵活性和切片缓存的性能优势，
              支持样式自定义、客户端渲染，是现代 Web 地图的常用数据源类型。
            </p>
            <div class="official-links">
              <el-link type="primary" href="https://openlayers.org/en/latest/apidoc/module-ol_source_VectorTile-VectorTileSource.html" target="_blank">
...
const apiData = [
  {
    ...
    description: '创建一个新的矢量切片数据源。矢量切片数据源用于加载 MVT/PBF 等格式的矢量切片数据。',
    params: [
      {
        name: 'options',
        type: 'Object',
        ...
        children: [
          ...
          { name: 'attributionsCollapsible', type: 'boolean', default: 'true', description: '归属信息是否可折叠' },
          { name: 'cacheSize', type: 'number', default: undefined, description: '初始切片缓存大小' },
          { name: 'extent', type: 'Extent', default: undefined, description: '范围' },
          { name: 'format', type: 'FeatureFormat', default: undefined, description: '切片要素格式（如 MVT）' },
          { name: 'overlaps', type: 'boolean', default: 'true', description: '源是否有重叠几何' },
          { name: 'projection', type: 'ProjectionLike', default: 'EPSG:3857', description: '切片源投影' },
          { name: 'state', type: 'State', default: undefined, description: '源状态' },
          { name: 'tileClass', type: 'Class', default: undefined, description: '实例化切片的类' },
          { name: 'maxZoom', type: 'number', default: '22', description: '最大缩放级别' },
          { name: 'minZoom', type: 'number', default: undefined, description: '最小缩放级别' },
          { name: 'tileSize', type: 'number|Size', default: '512', description: '切片大小' },
          { name: 'maxResolution', type: 'number', default: undefined, description: '零级别切片网格分辨率' },
          { name: 'tileGrid', type: 'TileGrid', default: undefined, description: '切片网格' },
          { name: 'tileLoadFunction', type: 'LoadFunction', default: undefined, description: '加载切片的函数' },
          { name: 'tileUrlFunction', type: 'UrlFunction', default: undefined, description: '获取切片 URL 的函数' },
          { name: 'url', type: 'string', default: undefined, description: 'URL 模板，需包含{x}, {y}, {z}' },
          { name: 'transition', type: 'number', default: undefined, description: '切片不透明度过渡时长 (毫秒)' },
          { name: 'urls', type: 'Array<string>', default: undefined, description: 'URL 模板数组' },
          { name: 'wrapX', type: 'boolean', default: 'true', description: '是否水平环绕世界' },
          { name: 'zDirection', type: 'number|Function', default: '1', description: '整数缩放级别间的切片选择' }
        ]
      }
    ],
    usage: `// ============================================
// VectorTileSource 构造函数使用示例
// ============================================
